...
(the points of interest) in the direction of PC1.
...
\paragraph{Coefficients} After the relatively aggressive pruning parameter of 
\texttt{nprune}$=45$ in the final model, the original set of 26 predictors were 
trimmed down to a 5-way interaction between the 10 listed in Table \ref{var-imp}.

\begin{table}[h!tb]
    \centering
    \begin{tabular}{llll}
        \textbf{variable}  & \textbf{nsubsets} & \textbf{gcv} & \textbf{rss} \\ \hline
