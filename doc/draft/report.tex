...
sites and night sky brightness readings are relatively sparse (~63\% missing).
Additionally the minimum time resolution of measurements is to the UTC hour instead
of the local hour.

\paragraph{Meteorological Data} There sure is a lot of ERA5 data.
...
\paragraph{Meteorological Data} TO-DO
